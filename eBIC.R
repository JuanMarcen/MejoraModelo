...
mod_0 <- step_rq_eBIC(df_conj_filled_sc[ind,1:31], response = 'Y', gamma = 0)
mod_0.5 <- step_rq_eBIC(df_conj_filled_sc[ind,1:31], response = 'Y', gamma = 0.5)
mod_1 <- step_rq_eBIC(df_conj_filled_sc[ind,1:31], response = 'Y', gamma = 1)
